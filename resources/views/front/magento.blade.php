...
<head>
    ...
    <title>Magento E-commerce - Luanda | Cape Town Design Website, Aplicativos Moveis, Online Marketing, SEO - Motor de busca, Logo Design
    </title>
...
<body>
    <!--Jumbotron-->
    <div id="gallery_id" class="jumbotron jumbotron-fluid">
        <div id="gallery_container" class="container">
            <h1 class="display-4">Solução Magento</h1>
